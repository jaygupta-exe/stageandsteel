...
async function run() {
  const files = [
    ...
    'public/whey protein/belgium chocalte/belgium chocalte.PNG',
    'public/whey protein/belgium chocalte/belgium chocalte2.PNG',
    'public/whey protein/belgium chocalte/belgium choclate 3.PNG',
    'public/whey protein/mocha protein/mocha protein.PNG',
    'public/whey protein/mocha protein/mocha protein 2.PNG',
    'public/whey protein/mocha protein/mocha protein 3.PNG',
