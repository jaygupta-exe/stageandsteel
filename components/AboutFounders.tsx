  ...
  return (
    <section id="about" className="relative w-full py-24 sm:py-32 bg-[#0F0F0E] text-[#F4F4F1] overflow-hidden border-t border-white/10">
      ...
      <div className="max-w-[1720px] mx-auto px-4 sm:px-8 lg:px-16 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 pt-16">
          ...
          <div className="relative flex flex-col justify-between bg-[#151514] border border-white/10 rounded-2xl p-6 sm:p-8 lg:p-10 shadow-2xl overflow-hidden group">
            ...
            <div>
              ...
              <p className="font-mono text-xs text-[#9DB25E] uppercase tracking-wider font-bold mb-6">
              ...
              <div className="relative w-full h-[400px] sm:h-[480px] rounded-xl overflow-hidden bg-[#0A0A09] border border-white/10 mb-6 group/img shadow-2xl flex items-center justify-center">
                ...
                <div className="relative w-full h-full p-2 z-10 flex items-center justify-center">
                  <Image
                    src={diveshImages[activeDiveshImg].src}
                    alt="Divesh Mehan - Champion Bodybuilder"
                    fill
                    unoptimized
                ...
                {diveshImages.map((img, idx) => (
                  <button
                    ...
                    className={`relative h-18 sm:h-20 rounded-lg overflow-hidden border-2 bg-[#0D0D0C] transition-all cursor-pointer ${
                      activeDiveshImg === idx
                        ? "border-[#596238] scale-102 shadow-lg ring-2 ring-[#596238]/30"
              ...
              <div className="p-4 sm:p-5 bg-[#0D0D0C] border border-white/10 rounded-xl mb-6 shadow-inner">
                <span className="text-[10px] font-mono text-[#9DB25E] uppercase tracking-widest block mb-3 font-bold flex items-center gap-1.5">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between p-2.5 bg-white/5 border border-white/5 rounded-lg">
                    ...
                    <span className="font-mono text-xs font-bold text-[#9DB25E] uppercase">NPC MIAMI</span>
                  </div>
                  <div className="flex items-center justify-between p-2.5 bg-white/5 border border-white/5 rounded-lg">
                    <span className="text-xs sm:text-sm font-display font-black text-[#F5F5F2] tracking-wide flex items-center gap-2">
                      🏆 1ST PLACE
                    </span>
                    <span className="font-mono text-xs font-bold text-[#9DB25E] uppercase">MUSCLEMANIA ASIA 2022</span>
                  </div>
                  <div className="flex items-center justify-between p-2.5 bg-white/5 border border-white/5 rounded-lg">
                    <span className="text-xs sm:text-sm font-display font-black text-[#F5F5F2] tracking-wide flex items-center gap-2">
                      🏆 1ST PLACE
                    </span>
                    <span className="font-mono text-xs font-bold text-[#9DB25E] uppercase">MUSCLEMANIA INDIA 2019</span>
                  </div>
                </div>
              </div>
          ...
          <div className="relative flex flex-col justify-between bg-[#151514] border border-white/10 rounded-2xl p-6 sm:p-8 lg:p-10 shadow-2xl overflow-hidden group">
            ...
            <div>
              ...
              <div className="p-4 sm:p-5 bg-[#0D0D0C] border border-[#596238]/40 rounded-xl mb-6 shadow-inner relative overflow-hidden">
                <div className="absolute top-0 right-0 p-3 opacity-10">
                  <Flame className="w-16 h-16 text-[#9DB25E]" />
                </div>
                <span className="text-[10px] font-mono text-[#9DB25E] uppercase tracking-widest block mb-2 font-bold flex items-center gap-1.5">
              ...
              <div className="space-y-4 text-xs sm:text-sm font-sans text-[#C4C3BE] leading-relaxed mb-6">
                ...
                <p>
                  A dedicated follower of the <strong className="text-[#9DB25E]">5 AM Club philosophy</strong>, he believes that discipline is the ultimate competitive advantage. For more than a decade, fitness, self-development, and purposeful living have remained at the core of his journey.
                </p>
                <p>
        ...
        {/* ========================================================================= */}
        <div className="mt-16 sm:mt-24 p-8 sm:p-12 lg:p-16 bg-gradient-to-b from-[#181816] to-[#10100F] border border-[#596238]/40 rounded-2xl shadow-[0_20px_60px_rgba(0,0,0,0.6)] relative overflow-hidden">
          
          {/* Subtle Ambient Glow */}
          <div className="absolute top-0 right-0 w-96 h-96 bg-[#596238]/15 rounded-full blur-3xl pointer-events-none" />
          
          <div className="max-w-4xl mx-auto text-center relative z-10">
            
            <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-[#596238]/20 border border-[#596238]/40 rounded-full text-xs font-mono font-bold tracking-widest text-[#9DB25E] uppercase mb-6">
            ...
            <h3 className="font-display text-3xl sm:text-5xl lg:text-6xl font-black uppercase text-[#F5F5F2] tracking-tight leading-[0.95] mb-6">
              ...
              <span className="text-[#9DB25E]">FOR EXCELLENCE</span>
            </h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 pt-8 border-t border-white/10">
              <div className="p-6 bg-[#0D0D0C] border border-white/10 rounded-xl text-center flex flex-col items-center">
                <span className="w-10 h-10 rounded-full bg-[#596238]/20 border border-[#596238]/40 text-[#9DB25E] flex items-center justify-center font-mono font-bold text-xs mb-3">
                  01
                </span>
